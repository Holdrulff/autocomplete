...
type ComplexityRoot struct {
	Query struct {
		Autocomplete func(childComplexity int, prefix string) int
	}
...
type QueryResolver interface {
	Autocomplete(ctx context.Context, prefix string) ([]autocomplete.Suggestion, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query.autocomplete":
		...
		return e.ComplexityRoot.Query.Autocomplete(childComplexity, args["prefix"].(string)), true

	case "Suggestion.score":
		if e.ComplexityRoot.Suggestion.Score == nil {
			break
		}

		return e.ComplexityRoot.Suggestion.Score(childComplexity), true
	case "Suggestion.value":
		if e.ComplexityRoot.Suggestion.Value == nil {
			break
		}

		return e.ComplexityRoot.Suggestion.Value(childComplexity), true
...
func (ec *executionContext) childFields_Suggestion(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
	switch field.Name {
	case "value":
		return ec.fieldContext_Suggestion_value(ctx, field)
	case "score":
		return ec.fieldContext_Suggestion_score(ctx, field)
	}
...
func (ec *executionContext) _Query_autocomplete(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			...
			return ec.Resolvers.Query().Autocomplete(ctx, fc.Args["prefix"].(string))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []autocomplete.Suggestion) graphql.Marshaler {
			return ec.marshalNSuggestion2ᚕgithubᚗcomᚋHoldrulffᚋautocompleteᚋinternalᚋautocompleteᚐSuggestionᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Suggestion_value(ctx context.Context, field graphql.CollectedField, obj *autocomplete.Suggestion) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_Suggestion_value(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
...
func (ec *executionContext) _Suggestion_score(ctx context.Context, field graphql.CollectedField, obj *autocomplete.Suggestion) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_Suggestion_score(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("Suggestion", field, false, false, errors.New("field of type Int does not have child fields"))
}
...
func (ec *executionContext) _Suggestion(ctx context.Context, sel ast.SelectionSet, obj *autocomplete.Suggestion) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "value":
			out.Values[i] = ec._Suggestion_value(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "score":
			out.Values[i] = ec._Suggestion_score(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
...
func (ec *executionContext) marshalNSuggestion2githubᚗcomᚋHoldrulffᚋautocompleteᚋinternalᚋautocompleteᚐSuggestion(ctx context.Context, sel ast.SelectionSet, v autocomplete.Suggestion) graphql.Marshaler {
	return ec._Suggestion(ctx, sel, &v)
}

func (ec *executionContext) marshalNSuggestion2ᚕgithubᚗcomᚋHoldrulffᚋautocompleteᚋinternalᚋautocompleteᚐSuggestionᚄ(ctx context.Context, sel ast.SelectionSet, v []autocomplete.Suggestion) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNSuggestion2githubᚗcomᚋHoldrulffᚋautocompleteᚋinternalᚋautocompleteᚐSuggestion(ctx, sel, v[i])
	})
